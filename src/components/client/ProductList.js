          ...
          <div className="min-h-[300px] flex items-center justify-center bg-white rounded-xl">
            <div className="text-center p-8 max-w-md">
              ...
              <h3 className="text-lg font-medium text-gray-700 mb-2">
                {searchQuery || selectedLetter ? 'No matching medicines found' : 'No medicines available'}
              </h3>
              ...
              {loading ? (
                ...
                products.map((product) => {
                  const medicine = {
                    ...
                    generic_name: product.description || product.generic_name || '',
                    id: product.id,
                    price: product.price,
                  ...
                  return (
                    ...
                    >
                      <MedicineCard medicine={medicine} viewMode={viewMode} isReadOnly={true} />
                    </div>
                  );
                })
              )}

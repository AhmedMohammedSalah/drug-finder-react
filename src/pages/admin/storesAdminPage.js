...
function StoresAdminPage() {
  ...
  useEffect(() => {
    setLoading(true);
    fetch(
      `https://ahmedmsalah.pythonanywhere.com/medical_stores/?page=${page}&page_size=${pageSize}`,
      {
  ...
  useEffect(() => {
    async function fetchOwners() {
      const uniqueOwners = Array.from(
        new Set((stores || []).map((s) => s.owner).filter(Boolean))
      );
          ...
          if (!newOwnerData[ownerId]) {
            try {
              const res = await fetch(
                `https://ahmedmsalah.pythonanywhere.com/users/users/${ownerId}/`,
                {
                  headers: { Authorization: `Bearer ${token}` },
                }
              );
  ...
  const handleAddSubmit = async (e) => {
    ...
    try {
      ...
      setAddError("Failed to add store");
    }
  };
  ...
  const handleEditSubmit = async (e) => {
    ...
    try {
      ...
      if (storeBanner) formData.append("store_banner", storeBanner);
      const res = await fetch(
        `https://ahmedmsalah.pythonanywhere.com/medical_stores/${editStore.id}/`,
        {
          method: "PATCH",
          headers: { Authorization: `Bearer ${token}` },
          body: formData,
  ...
  const handleDelete = async (id) => {
    try {
      await fetch(
        `https://ahmedmsalah.pythonanywhere.com/medical_stores/${id}/`,
        {
          method: "DELETE",
          headers: { Authorization: `Bearer ${token}` },
        }
  ...
  return (
    <div className="relative min-h-screen">
      <AdminLoader
        loading={loading}
        error={error}
        loadingMessage="Loading stores data..."
      />
      ...
      >
        <div
          className={`flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-blue-50 to-white rounded-lg p-2 sm:p-4 md:p-6 transition-opacity duration-300 ${
              ...
              >
                {store.store_banner && (
                  <div className="relative mb-2">
                    <img
                      src={
                        typeof store.store_banner === "string"
                          ? store.store_banner
                          : URL.createObjectURL(store.store_banner)
                      }
                      alt="Banner"
                ...
                <div className="flex items-center gap-3 mb-2">
                  {store.store_logo && (
                    <div className="relative">
                      <img
                        src={
                          typeof store.store_logo === "string"
                            ? store.store_logo
                            : URL.createObjectURL(store.store_logo)
                        }
                        alt="Logo"
                  ...
                  <div>
                    ...
                    {ownerData[store.owner] ? (
                      <div className="text-xs text-blue-500 font-semibold flex flex-col">
                        <span>
                          Owner: {ownerData[store.owner].name}{" "}
                          {ownerData[store.owner].last_name}
                        </span>
                        <span className="text-gray-500">
                          Email: {ownerData[store.owner].email}
                        </span>
                ...
                <div className="flex gap-2 mt-2 justify-end">
                  <button
                    ...
                    onClick={() => setShowDetailsStore(store)}
                  >
                    Details
                  </button>
                  <button
                ...
                >
                  ...
                  <div className="flex flex-col gap-4 p-8 pt-6">
                    ...
                    <FileUpload
                      ...
                      accept="image/*"
                      onFileChange={(file) =>
                        handleAddFile("license_image", file)
                      }
                      required
                    />
                    {licenseImage && (
                      <div className="flex flex-col items-center mt-2">
                        ...
                        <img
                          ...
                          alt="License Preview"
                          className="w-32 h-32 object-cover rounded-xl border-2 border-blue-200 shadow-md transition-transform duration-200 hover:scale-105"
                        />
                      </div>
                    )}
                    <input
                    ...
                    <FileUpload
                      label="Store Logo"
                      accept="image/*"
                      onFileChange={(file) => handleAddFile("store_logo", file)}
                    />
                    {storeLogo && (
                      <div className="flex flex-col items-center mt-2">
                        <span className="text-xs text-gray-500 mb-1">
                        ...
                        <img
                          ...
                          alt="Logo Preview"
                          className="w-20 h-20 object-cover rounded-full border-2 border-blue-200 shadow-md transition-transform duration-200 hover:scale-105"
                        />
                      </div>
                    )}
                    <FileUpload
                      ...
                      accept="image/*"
                      onFileChange={(file) =>
                        handleAddFile("store_banner", file)
                      }
                    />
                    {storeBanner && (
                      <div className="flex flex-col items-center mt-2">
                        ...
                        <img
                          src={URL.createObjectURL(storeBanner)}
                          alt="Banner Preview"
                          className="w-full max-w-xs h-24 object-cover rounded-xl border-2 border-blue-200 shadow-md transition-transform duration-200 hover:scale-105"
                        />
                      </div>
                    )}
                    <textarea
                    ...
                    <div className="flex gap-4">
                      <input
                        ...
                        onChange={handleAddChange}
                        className="border border-blue-300 rounded-lg px-4 py-2 w-1/2 focus:ring-2 focus:ring-blue-400"
            ...
            <>
              ...
              <div className="fixed inset-0 flex items-center justify-center z-50">
                <form
                  ...
                  className="bg-white rounded-2xl p-4 sm:p-8 shadow-2xl flex flex-col gap-6 min-w-[90vw] sm:min-w-[900px] max-w-5xl max-h-[95vh] overflow-y-auto border-2 border-blue-200 relative animate-fadeIn"
                >
                  <div className="flex flex-col items-center justify-center rounded-t-3xl bg-gradient-to-r from-blue-500 to-blue-400 p-6">
                    <span className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-white border-4 border-blue-200 mb-2 shadow-lg">
                      <svg
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8 p-8 pt-6">
                    ...
                    <div className="flex flex-col gap-4">
                      <label className="font-semibold text-gray-700">
                        License Image (leave blank to keep current)
                      </label>
                      <FileUpload
                        accept="image/*"
                        onFileChange={(file) =>
                          handleEditFile("license_image", file)
                        }
                      />
                          ...
                          <img
                            src={
                              licenseImage
                                ...
                                : typeof editForm.license_image === "string"
                                ? editForm.license_image
                                : URL.createObjectURL(editForm.license_image)
                            }
                            alt="License Preview"
                            className="w-32 h-32 object-cover rounded-xl border-2 border-blue-200 shadow-md transition-transform duration-200 hover:scale-105"
                          />
                      ...
                      <label className="font-semibold text-gray-700">
                        Store Logo (leave blank to keep current)
                      </label>
                      <FileUpload
                        accept="image/*"
                        onFileChange={(file) =>
                          handleEditFile("store_logo", file)
                        }
                      />
                          ...
                          <img
                            src={
                              storeLogo
                                ...
                                : typeof editForm.store_logo === "string"
                                ? editForm.store_logo
                                : URL.createObjectURL(editForm.store_logo)
                            }
                            alt="Logo Preview"
                            className="w-20 h-20 object-cover rounded-full border-2 border-blue-200 shadow-md transition-transform duration-200 hover:scale-105"
                          />
                      ...
                      <label className="font-semibold text-gray-700">
                        Store Banner (leave blank to keep current)
                      </label>
                      <FileUpload
                        accept="image/*"
                        onFileChange={(file) =>
                          handleEditFile("store_banner", file)
                        }
                      />
                      {(storeBanner || editForm.store_banner) && (
                        <div className="flex flex-col items-center mt-2">
                          ...
                          <img
                            src={
                              storeBanner
                                ? URL.createObjectURL(storeBanner)
                                : typeof editForm.store_banner === "string"
                                ? editForm.store_banner
                  ...
                  <div className="flex gap-4 mt-6 justify-end px-8 pb-8">
                    <button
                      type="submit"
                      className="bg-blue-600 hover:bg-blue-700 text-white px-8 py-3 rounded-xl font-bold shadow transition-all focus:outline-none focus:ring-2 focus:ring-blue-400 text-lg"
                    >
                      Save
                    </button>
                    <button
                      type="button"
                      className="bg-gray-200 hover:bg-gray-300 text-gray-800 px-8 py-3 rounded-xl font-semibold shadow transition-all focus:outline-none text-lg"
              ...
              <div className="fixed inset-0 flex items-center justify-center z-50">
                <div className="bg-white rounded-2xl p-4 sm:p-8 shadow-2xl flex flex-col gap-6 min-w-[90vw] sm:min-w-[350px] max-w-md max-h-[90vh] overflow-y-auto border-2 border-blue-200 relative animate-fadeIn">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8 p-8 pt-6">
                    <div className="flex flex-col gap-3">
                      <div>
                        <b>Name:</b> {showDetailsStore.store_name}
                      </div>
                      <div>
                        <b>Type:</b> {showDetailsStore.store_type}
                      </div>
                      <div>
                        <b>Owner:</b>{" "}
                        {ownerData[showDetailsStore.owner] ? (
                          <span>
                            {ownerData[showDetailsStore.owner].name}{" "}
                            {ownerData[showDetailsStore.owner].last_name}
                            <br />
                            <span className="text-gray-500">
                              Email: {ownerData[showDetailsStore.owner].email}
                            </span>
                            <br />
                      ...
                      <div>
                        <b>License Expiry:</b>{" "}
                        {showDetailsStore.license_expiry_date}
                      </div>
                      <div>
                        <b>Description:</b>{" "}
                        {showDetailsStore.description || "N/A"}
                      </div>
                      <div>
                        <b>Latitude:</b> {showDetailsStore.latitude || "N/A"}
                      </div>
                      <div>
                        <b>Longitude:</b> {showDetailsStore.longitude || "N/A"}
                      </div>
                    </div>
                    <div className="flex flex-col gap-4">
                      {showDetailsStore.license_image && (
                        <div>
                          <b>License Image:</b>
                          <br />
                          <img
                            src={
                              typeof showDetailsStore.license_image === "string"
                                ? showDetailsStore.license_image
                                : URL.createObjectURL(
                                    showDetailsStore.license_image
                                  )
                            ...
                            alt="License"
                            className="w-32 h-32 object-cover rounded-xl border-2 border-blue-200 shadow-md mt-2"
                          />
                        </div>
                      )}
                      {showDetailsStore.store_logo && (
                        <div>
                          <b>Logo:</b>
                          <br />
                          <img
                            src={
                              typeof showDetailsStore.store_logo === "string"
                                ? showDetailsStore.store_logo
                                : URL.createObjectURL(
                                    showDetailsStore.store_logo
                                  )
                            ...
                            alt="Logo"
                            className="w-20 h-20 object-cover rounded-full border-2 border-blue-200 shadow-md mt-2"
                          />
                        </div>
                      )}
                      {showDetailsStore.store_banner && (
                        <div>
                          <b>Banner:</b>
                          <br />
                          <img
                            src={
                              typeof showDetailsStore.store_banner === "string"
                                ? showDetailsStore.store_banner
                                : URL.createObjectURL(
                                    showDetailsStore.store_banner
                                  )
                            ...
                            alt="Banner"
                            className="w-full max-w-xs h-24 object-cover rounded-xl border-2 border-blue-200 shadow-md mt-2"
                          />
                        </div>
                      )}
                    </div>
                  ...
                  <div className="flex gap-4 mt-2 justify-end px-8 pb-8">
                    <button
                      className="bg-gray-200 hover:bg-gray-300 text-gray-800 px-8 py-3 rounded-xl font-semibold shadow transition-all focus:outline-none"
                      onClick={() => setShowDetailsStore(null)}
                    >
                      Close
                    </button>
                  </div>
                ...
                <div className="bg-white rounded-2xl p-4 sm:p-8 shadow-2xl flex flex-col gap-6 min-w-[90vw] sm:min-w-[350px] max-w-md max-h-[90vh] overflow-y-auto border-2 border-red-200 relative animate-fadeIn">
                  ...
                  <div className="flex flex-col gap-4 p-8 pt-6">
                    ...
                    <div className="flex gap-4 mt-2 justify-end">
                      <button
                        onClick={async () => {
                          await handleDelete(deleteStoreId);

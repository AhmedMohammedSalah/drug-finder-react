              ...
              <div className="sm:hidden sticky top-0 z-30 bg-gradient-to-br from-blue-50 to-white rounded-xl shadow border border-blue-200 mb-2">
                <div className="flex items-center justify-between px-4 py-2">
                  <div className="flex gap-2 items-center">
                    ...
                    {/* Filter chips */}
                    {search && (
                      <span className="bg-blue-100 text-blue-700 px-2 py-1 rounded-full text-xs ml-1">
                        Search: {search}
                      </span>
                    )}
                    {roleFilter && (
                          ...
                          <div><b>Updated:</b> {detailsUser.updated_at ? new Date(detailsUser.updated_at).toLocaleString() : 'N/A'}</div> */}
                            ...
                            detailsUser.client_profile ? (
                              <>
                                ...
                                <div>
                                  <b>Disease:</b>{" "}
                                  {detailsUser.client_profile.info_disease ||
                                    "N/A"}
                                </div>
                                <div>
                                  <b>Profile Image:</b>{" "}
                        ...
                        <label className="block mt-2">
                          ...
                          {addPharmacistImages.image_profile &&
                            typeof addPharmacistImages.image_profile ===
                              ...
                              <div className="text-xs text-blue-700 mt-1">
                                Selected:{" "}
                                {addPharmacistImages.image_profile.name}
                              </div>
                            )}
                        </label>
                        <label className="block mt-2">
                          ...
                          {addPharmacistImages.image_license &&
                            typeof addPharmacistImages.image_license ===
                              ...
                              <div className="text-xs text-blue-700 mt-1">
                                Selected:{" "}
                                {addPharmacistImages.image_license.name}
                              </div>
                            )}
                        </label>
                      </>

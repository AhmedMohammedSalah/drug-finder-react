            ...
            >
              ...
              <div className="flex flex-col gap-4 p-8 pt-6">
                ...
                <FileUpload
                  label="License Image"
                  accept="image/*"
                  onFileChange={(file) => handleAddFile("license_image", file)}
                  required
                />
                {licenseImage && (
                ...
                <FileUpload
                  label="Store Banner"
                  accept="image/*"
                  onFileChange={(file) => handleAddFile("store_banner", file)}
                />
                {storeBanner && (
                  <div className="flex flex-col items-center mt-2">
                    <span className="text-xs text-gray-500 mb-1">Preview:</span>
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 p-8 pt-6">
                ...
                <div className="flex flex-col gap-4">
                  ...
                  <FileUpload
                    label="License Image (leave blank to keep current)"
                    accept="image/*"
                    onFileChange={(file) =>
                  ...
                  <FileUpload
                    label="Store Logo (leave blank to keep current)"
                    accept="image/*"
                    onFileChange={(file) => handleEditFile("store_logo", file)}
                  />
                  ...
                  <FileUpload
                    label="Store Banner (leave blank to keep current)"
                    accept="image/*"
                    onFileChange={(file) =>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-2xl flex flex-col gap-6 min-w-[350px] max-w-[95vw] max-h-[90vh] overflow-y-auto border-2 border-blue-200 relative animate-fadeIn">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 p-8 pt-6">
                <div className="flex flex-col gap-3">
                  ...
                  <div>
                    <b>Description:</b> {showDetailsStore.description || "N/A"}
                  </div>
                  <div>
                      ...
                      <img
                        src={
                          typeof showDetailsStore.store_logo === "string"
                            ? showDetailsStore.store_logo
                            : URL.createObjectURL(showDetailsStore.store_logo)
                        }
                        alt="Logo"
                      ...
                      <img
                        src={
                          typeof showDetailsStore.store_banner === "string"
                            ? showDetailsStore.store_banner
                            : URL.createObjectURL(showDetailsStore.store_banner)
                        }
                        alt="Banner"
